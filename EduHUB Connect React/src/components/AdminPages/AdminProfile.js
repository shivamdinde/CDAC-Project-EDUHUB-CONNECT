...
function AdminProfile() {
  ...
  const [sRole, setsRole] = useState(UserRole.ADMIN);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.put("http://localhost:9090/api/student/profile", formData, {
        headers: {
  ...
  return (
    <MDBContainer fluid className="p-4 background-radial-gradient overflow-hidden spectrum-background">
      <MDBRow>
        <MDBCol md="10" className="position-relative mx-auto"> {/* Change md="6" to md="10" */}
          <MDBCard className="my-5 bg-glass">
            <MDBCardBody >
              <div className="d-flex flex-column justify-content-center h-custom-2 w-75 pt-4">
                <h3 className="Auth-form-title">Update Admin Profile</h3>
                <MDBInput
