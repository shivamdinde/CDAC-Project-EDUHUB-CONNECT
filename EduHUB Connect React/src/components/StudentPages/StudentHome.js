...
import GetUserAttendence from '../Attendance/GetUserAttendence';
      ...
      <div className="container-fluid h-100 ">
        <div className="row h-100">
          ...
          <div className="col-md-10 col-sm-12 rounded h-100">
            ...
            {activeContent === 'profile_update' && <StudentProfile />}
            {activeContent === 'item2' && <StudentAssignment />}
            {activeContent === 'item3' && <GetUserAttendence />}
